...
INSERT INTO visits(cancel_visit, doctor_Id, patient_Id, visit_date)
values (false, 1, 1, '2023-09-23 15:30:00'),
...
INSERT INTO patients_cards (date_of_visit, doctor_id, id, patient_id, diagnosis, note_doctor, symptoms, treatment)
VALUES ('2024-10-01 10:00:00', 1, 1, 1, 'Flu', 'Regular checkup', 'Fever, cough', 'Rest, hydration'),
       ...
       ('2024-10-12 13:00:00', 1, 4, 4, 'Back pain', 'Physiotherapy recommended', 'Lower back pain',
        'Physical therapy'),
       ...
       ('2024-10-25 16:00:00', 3, 9, 9, 'Diabetes', 'Blood sugar monitored', 'Frequent urination',
        'Diet change, insulin'),
       ...
       ('2024-11-03 11:30:00', 2, 12, 2, 'Allergies', 'Antihistamines prescribed', 'Itchy eyes, runny nose',
        'Antihistamines'),
       ('2024-11-06 09:30:00', 3, 13, 3, 'Migraine', 'Advised rest', 'Severe headache', 'Painkillers'),
       ('2024-11-10 13:30:00', 1, 14, 4, 'Back pain', 'Referred to specialist', 'Lower back stiffness',
        'Physical therapy'),
...
VALUES ('malwina.kozak@gmail.com', 'proste1234', 'PATIENT'),
